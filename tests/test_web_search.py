...
def test_web_search_inserts_only_recent_items(tmp_path, monkeypatch):
    ...
    items = [
        ...
        },
        {
            ...
            "author": "example.com",
            "published_at": "2013-11-06T10:00:00Z",
            "excerpt": "Old item",
            "content": None,
            "dedupe_hash": "hash-old-iso",
            "metadata": {"query": "test"},
            "ingested_at": fixed_now.isoformat(),
        },
        {
            "source_type": "web",
            "title": "Too Old RFC822",
            "url": "https://example.com/old-rfc822",
            "author": "example.com",
            "published_at": "Wed, 06 Nov 2013 10:00:00 GMT",
            "excerpt": "Old item",
            "content": None,
            "dedupe_hash": "hash-old-rfc822",
            "metadata": {"query": "test"},
            "ingested_at": fixed_now.isoformat(),
        },
        {
